...
namespace PMMS.Default.Entities
{
    ...
    [DisplayName("Import Wizard Data"), InstanceName("Import Wizard Data")]
    ...
    public sealed class ImportWizerdDataRow : Row, IIdRow, INameRow
    {
