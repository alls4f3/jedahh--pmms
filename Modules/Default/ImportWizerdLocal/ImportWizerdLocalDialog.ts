...
namespace PMMS.Default {
    ...
    export class ImportWizerdLocalDialog extends Serenity.EntityDialog<ImportWizerdLocalRow, any> {
        protected getFormKey() { return ImportWizerdLocalForm.formKey; }
        protected getIdProperty() { return ImportWizerdLocalRow.idProperty; }
        protected getLocalTextPrefix() { return ImportWizerdLocalRow.localTextPrefix; }
        protected getNameProperty() { return ImportWizerdLocalRow.nameProperty; }
        protected getService() { return ImportWizerdLocalService.baseUrl; }
        protected getDeletePermission() { return ImportWizerdLocalRow.insertPermission; }


        protected form = new ImportWizerdLocalForm(this.idPrefix);
