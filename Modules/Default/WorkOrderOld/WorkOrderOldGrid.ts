...
namespace PMMS.Default {
    ...
    export class WorkOrderOldGrid extends Serenity.EntityGrid<WorkOrderOldRow, any> {
        protected getColumnsKey() { return 'Default.WorkOrderOld'; }
        protected getDialogType() { return WorkOrderOldDialog; }
        protected getIdProperty() { return WorkOrderOldRow.idProperty; }
        protected getInsertPermission() { return WorkOrderOldRow.insertPermission; }
