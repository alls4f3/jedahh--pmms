...
namespace PMMS.Default.Entities
{
    ...
    [ConnectionKey("Default"), Module("Default"), TableName("[dbo].[WorkOrder_old]")]
    [DisplayName("Work Order Old"), InstanceName("Work Order Old")]
    ...
    public sealed class WorkOrderOldRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("<span style='color:red'></span>Items")]
        [StaticTextBlock(HideLabel = false, IsHtml = true, IsLocalText = false, Text = "<table class=' table table-bordered' style='width:100%; background-color:#607D8B;'> <thead class='thead-dark'> <tr> <th>ITM_CODE</th><th>ITM_DESC </th>  <th>UNIT</th> <th>EXEC_QTY</th> <th>REMAIN DER</th>  <th>PREV_EXEC_QTY</th> <th>QUANTITY</th> </tr> </thead> <tbody id='bodyBOQTemplates'> </tbody> </table>")]

        [NotMapped]


        public string WorkorderBoqItem
        {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField WorkorderBoqItem;
