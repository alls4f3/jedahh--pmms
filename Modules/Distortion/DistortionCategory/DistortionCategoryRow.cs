...
namespace PMMS.Distortion.Entities
{
    ...
    [ConnectionKey("Default"), Module("Distortion"), TableName("[dbo].[DistortionCategory]")]
    [DisplayName("Distortion Category"), InstanceName("Distortion Category")]
    ...
    public sealed class DistortionCategoryRow : Row, IIdRow, INameRow
    {
