...
{
    public class CopyMaintenance_Cost_Calculations
    {
        ...
        public string Maintenance_Cost_Calc(string contractor_no, string zone, string area, string City)
        {
            try
            {
                    ...
                    for (int SE = 0; SE < dt.Rows.Count; SE++)
                    {
                       // SE = 5;
                        ...
                        for (int i = 1; i <= 6; i++)
                        {
                            ...
                            var GetAll3 = cd.GetData("Select * from Maintenance_Factors Where Maintenance_Factor_No = '" + Maintenance_Factor_No + "'");/// & "'" & Current_MR_Section_No & "'
                        ...
                        for (int J = 11; J >= 0; J--)
                        {
                            ...
                            var sql2 = cd.GetData("Select * from Maintenance_Factors Where Maintenance_Factor_No = '" + Current_MR_Section_No2 + "'");
                            ...
                            var sql3 = cd.GetData("Select * from Maintenance_Factors Where Maintenance_Factor_No = '" + Current_MR_Section_No3 + "'");
                            ///exec sql4
                            ...
                            var sql6 = cd.GetData("Select * from Maintenance_Factors Where Maintenance_Factor_No = '" + Current_MR_Section_No6 + "'");
                            ...
                            var sql4 = cd.GetData("Select * from Maintenance_Factors Where Maintenance_Factor_No = '" + Current_MR_Section_No4 + "'");
                            ...
                            var sql5 = cd.GetData("Select * from Maintenance_Factors Where Maintenance_Factor_No = '" + Current_MR_Section_No5 + "'");
                            ...
                            var sql7 = cd.GetData("Select * from Maintenance_Factors Where Maintenance_Factor_No = '" + Current_MR_Section_No7 + "'");
                                ...
                                if (dtPCI.Rows[i]["Section_PCI"].ToString() != null)
                                {
                                    ...
                                    if (Previous_Contractor_No1 != int.Parse(Current_Contractor_No))
                                    {
                                        ...
                                        for (int K = 1; K <= 45; K++)
                                        {
                                            ...
                                            var sqlMC = cd.GetData("Select * from Contractor_Maintenance_Cost Where Maintenance_Cost_ID = '" + K + "' and Contractor_No = " + Current_Contractor_No + "");
                                            ///EXEC SQLMC
                                        ...
                                        for (int KK = 1; KK <= 8; KK++)
                                        {
                                            ...
                                            var sqlK = cd.GetData("Select * from Contractor_Maintenance_Cost Where Maintenance_Cost_ID ='" + KK + "m' and Contractor_No = " + Current_Contractor_No + "");
                                            ///exec sqlk
                                    ...
                                    //    var sqlDSA = cd.GetData("Select * from Distress_Samples Where Section_No = '" + dt.Rows[SE]["Section_No"].ToString() + "' ");
                                       ...
                                       //string SetMandR1 = BuCal.SetMandR(MR1, Section_Type, Density, MR_Cost_Ovrd1, S_Type1, dt.Rows[SE]["Section_No"].ToString());
                                        ...
                                        var sql111 = cd.GetData("Select * from Maintenance_Factors Where Maintenance_Factor_No = 'F1'");
                                        DataTable dtSql111 = (DataTable)sql111;
                                        if (dtSql111.Rows.Count > 0)
                                        {
                                            if (dtSql111.Rows[0]["Maintenance_Factor_Value"].ToString() == "Y")
                                            {
                                                var sql112 = cd.GetData("Select * from Maintenance_Factors Where Maintenance_Factor_No = 'A2'");
                                        ...
                                        var sql114 = cd.GetData("Select * from Maintenance_Factors Where Maintenance_Factor_No = 'F2'");
                                        ////exec
                                        ...
                                        if (dtsql114.Rows.Count > 0)
                                        {
                                            ...
                                            {
                                                var sql115 = cd.GetData("Select * from Maintenance_Factors Where Maintenance_Factor_No = 'A3'");
                                                ///exec sql115
                ...
                //            var GetAll3 = cd.GetData("Select * from Maintenance_Factors Where Maintenance_Factor_No = '" + Current_MR_Section_No + "'");/// & "'" & Current_MR_Section_No & "'
                //            DataTable dtTest = (DataTable)GetAll3;
                //            if (dtTest.Rows.Count > 0)
                //            {
                ...
                //            var GetAll9 = cd.GetData("Select * from Maintenance_Factors Where Maintenance_Factor_No = '" + Current_MR_Section_No + "'");/// & "'" & Current_MR_Section_No & "'
