...
namespace PMMS.EAM.Entities
{
    ...
    [ConnectionKey("Default"), Module("EAM"), TableName("[dbo].[AssetCategory]")]
    [DisplayName("Asset Category"), InstanceName("Asset Category")]
    ...
    public sealed class AssetCategoryRow : Row, IIdRow, INameRow
    {
