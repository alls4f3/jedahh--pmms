...
namespace PMMS.EAM.Entities
{
    ...
    [ConnectionKey("Default"), Module("EAM"), TableName("[dbo].[AssetStatus]")]
    [DisplayName("Asset Status"), InstanceName("Asset Status")]
    ...
    public sealed class AssetStatusRow : Row, IIdRow, INameRow
    {
