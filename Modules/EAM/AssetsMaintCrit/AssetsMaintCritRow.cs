...
namespace PMMS.EAM.Entities
{
    ...
    [ConnectionKey("Default"), Module("EAM"), TableName("[dbo].[AssetsMaintCrit]")]
    [DisplayName("Assets Maint Crit"), InstanceName("Assets Maint Crit")]
    ...
    public sealed class AssetsMaintCritRow : Row, IIdRow, INameRow
    {
