...
namespace PMMS.EAM.Entities
{
    ...
    [ConnectionKey("Default"), Module("EAM"), TableName("[dbo].[AssetLocation]")]
    [DisplayName("Asset Location"), InstanceName("Asset Location")]
    ...
    public sealed class AssetLocationRow : Row, IIdRow, INameRow
    {
