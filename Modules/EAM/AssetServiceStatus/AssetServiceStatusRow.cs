...
namespace PMMS.EAM.Entities
{
    ...
    [ConnectionKey("Default"), Module("EAM"), TableName("[dbo].[AssetServiceStatus]")]
    [DisplayName("Asset Service Status"), InstanceName("Asset Service Status")]
    ...
    public sealed class AssetServiceStatusRow : Row, IIdRow, INameRow
    {
