...
namespace PMMS.EAM.Entities
{
    ...
    [ConnectionKey("Default"), Module("EAM"), TableName("[dbo].[AssetType]")]
    [DisplayName("Asset Feature"), InstanceName("Asset Feature")]
    ...
    [LookupScript]
    public sealed class AssetTypeRow : Row, IIdRow, INameRow
    {
