...
namespace PMMS.EAM.Entities
{
    ...
    [ConnectionKey("Default"), Module("EAM"), TableName("[dbo].[AssetTags]")]
    [DisplayName("Asset Tags"), InstanceName("Asset Tags")]
    ...
    public sealed class AssetTagsRow : Row, IIdRow, INameRow
    {
