...
namespace PMMS.EAM.Entities
{
    ...
    [ConnectionKey("Default"), Module("EAM"), TableName("[dbo].[AssetsMaintSubSet]")]
    [DisplayName("Assets Maint Sub Set"), InstanceName("Assets Maint Sub Set")]
    ...
    public sealed class AssetsMaintSubSetRow : Row, IIdRow, INameRow
    {
