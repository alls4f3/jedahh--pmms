...
namespace PMMS.EAM.Entities
{
    ...
    [ConnectionKey("Default"), Module("EAM"), TableName("[dbo].[AssetsMaintCondation]")]
    [DisplayName("Assets Maint Condation"), InstanceName("Assets Maint Condation")]
    ...
    public sealed class AssetsMaintCondationRow : Row, IIdRow, INameRow
    {
        ...
        public AssetsMaintCondationRow()
            : base(Fields)
        {
        }
