...
namespace PMMS.EAM.Entities
{
    ...
    [ConnectionKey("Default"), Module("EAM"), TableName("[dbo].[AssetDimansion]")]
    [DisplayName("Asset Dimansion"), InstanceName("Asset Dimansion")]
    ...
    public sealed class AssetDimansionRow : Row, IIdRow, INameRow
    {
