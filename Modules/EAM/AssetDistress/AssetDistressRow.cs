...
namespace PMMS.EAM.Entities
{
    ...
    [ConnectionKey("Default"), Module("EAM"), TableName("[dbo].[AssetDistress]")]
    [DisplayName("Asset Distress"), InstanceName("Asset Distress")]
    ...
    [LookupScript]
    public sealed class AssetDistressRow : Row, IIdRow, INameRow
    {
