...
namespace PMMS.EAM.Entities
{
    ...
    [ConnectionKey("Default"), Module("EAM"), TableName("[dbo].[AssetAttr]")]
    [DisplayName("Asset Attr"), InstanceName("Asset Attr")]
    ...
    [LookupScript]
    public sealed class AssetAttrRow : Row, IIdRow, INameRow
    {
